import 'node:fs';
import 'node:path';
import { b as br, O as On } from '../shared/nuxi.BrE13ZGm.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
