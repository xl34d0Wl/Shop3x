...
import { readFile, mkdir as mkdir$1, rm, writeFile } from 'node:fs/promises';
import fs__default, { existsSync, readdirSync, createWriteStream } from 'node:fs';
import { c as commonjsGlobal } from '../shared/nuxi.E-ZsRS8r.mjs';
...
import fs from 'fs';
import require$$5 from 'process';
import require$$0$3 from 'util';
import require$$1$2 from 'crypto';
import { d as defu } from '../shared/nuxi.DdI-vRyV.mjs';
import 'node:module';
import { a as resolve, j as join, n as normalize, r as relative, d as dirname, b as basename } from '../shared/nuxi.BZI8rqcO.mjs';
import me, { pipeline } from 'node:stream';
import { spawnSync } from 'node:child_process';
import os, { homedir } from 'node:os';
import require$$8, { promisify } from 'node:util';
import vt from 'node:http';
import https from 'node:https';
import require$$10 from 'node:url';
import assert from 'node:assert';
import require$$12 from 'node:net';
import require$$8$1 from 'node:buffer';
...
import { i as installDependencies$1 } from '../shared/nuxi.BbDL64qi.mjs';
import { x as ve } from './main.mjs';
import { c as cwdArgs } from '../shared/nuxi.DpekDEZq.mjs';
import { r as resolve$1, a as relative$1 } from '../shared/nuxi.BHLUJ6h2.mjs';
...
function requireMinizlib () {
	...
	const Buffer = require$$1$1.Buffer;
	const realZlib = require$$0$1;

	const constants = minizlib.constants = requireConstants();
...
function requireHeader () {
	...
	const pathModule = sysPath__default.posix;
...
function requireStripAbsolutePath () {
	...
	const { isAbsolute, parse } = sysPath__default.win32;
...
function requireFsMinipass () {
	...
	const MiniPass = requireMinipass();
	const EE = require$$0.EventEmitter;
	const fs$1 = fs;
...
function requireOptsArg () {
	...
	const optsArg = opts => {
	  if (!opts)
	    opts = { mode: 0o777, fs: fs$1 };
	  else if (typeof opts === 'object')
	    opts = { mode: 0o777, fs: fs$1, ...opts };
...
function requirePathArg () {
	...
	const { resolve, parse } = sysPath__default;
	const pathArg = path => {
	  if (/\0/.test(path)) {
...
function requireFindMade () {
	...
	const {dirname} = sysPath__default;
...
function requireChownr () {
	...
	const chownSync = (path, uid, gid) => {
	  try {
	    return fs$1.chownSync(path, uid, gid)
	  } catch (er) {
	    if (er.code !== 'ENOENT')
	      throw er
	  }
	...
	const chown = (cpath, uid, gid, cb) => {
	  fs$1[LCHOWN](cpath, uid, gid, handleEISDIR(cpath, uid, gid, er => {
	    // Skip ENOENT error
	...
	const chownrKid = (p, child, uid, gid, cb) => {
	  if (typeof child === 'string')
	    return fs$1.lstat(path.resolve(p, child), (er, stats) => {
	      // Skip ENOENT error
	      if (er)
	...
	const chownrKidSync = (p, child, uid, gid) => {
	  if (typeof child === 'string') {
	    try {
	      const stats = fs$1.lstatSync(path.resolve(p, child));
	      stats.name = child;
	      child = stats;
	    } catch (er) {
	      if (er.code === 'ENOENT')
...
const importExeca = cached(() => import('./index6.mjs').then((r) => r.execa));
...
var hasRequiredNodeFetchNative_61758d11;

function requireNodeFetchNative_61758d11 () {
	if (hasRequiredNodeFetchNative_61758d11) return nodeFetchNative_61758d11;
	hasRequiredNodeFetchNative_61758d11 = 1;
var l=Object.defineProperty;var o=(e,t)=>l(e,"name",{value:t,configurable:true});var commonjsGlobal$1=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof commonjsGlobal<"u"?commonjsGlobal:typeof self<"u"?self:{};function getDefaultExportFromCjs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}o(getDefaultExportFromCjs,"getDefaultExportFromCjs"),nodeFetchNative_61758d11.commonjsGlobal=commonjsGlobal$1,nodeFetchNative_61758d11.getDefaultExportFromCjs=getDefaultExportFromCjs;
	return nodeFetchNative_61758d11;
}
...
function requireDist () {
	...
	hasRequiredDist = 1;
var i=Object.defineProperty;var l=(r,t)=>i(r,"name",{value:t,configurable:true});Object.defineProperty(dist,"__esModule",{value:true});const node=requireNode();requireNodeFetchNative_61758d11();var s=Object.defineProperty,e=l((r,t)=>s(r,"name",{value:t,configurable:true}),"e");const o=!!globalThis.process?.env?.FORCE_NODE_FETCH;function p(){return !o&&globalThis.fetch?globalThis.fetch:node.fetch}l(p,"p"),e(p,"_getFetch");const fetch=p(),Blob=!o&&globalThis.Blob||node.Blob,File=!o&&globalThis.File||node.File,FormData=!o&&globalThis.FormData||node.FormData,Headers=!o&&globalThis.Headers||node.Headers,Request=!o&&globalThis.Request||node.Request,Response=!o&&globalThis.Response||node.Response,AbortController=!o&&globalThis.AbortController||node.AbortController;dist.AbortError=node.AbortError,dist.FetchError=node.FetchError,dist.blobFrom=node.blobFrom,dist.blobFromSync=node.blobFromSync,dist.fileFrom=node.fileFrom,dist.fileFromSync=node.fileFromSync,dist.isRedirect=node.isRedirect,dist.AbortController=AbortController,dist.Blob=Blob,dist.File=File,dist.FormData=FormData,dist.Headers=Headers,dist.Request=Request,dist.Response=Response,dist.default=fetch,dist.fetch=fetch;
	return dist;
}
...
`),"normalizeLinefeeds"),QA=[],$=new Uint8Array([13,10]);gA=0;let AA=false;for(const[hA,fA]of N)if(typeof fA=="string"){const RA=M.encode(aA+`; name="${bA(rA(hA))}"\r
\r
${rA(fA)}\r
...
async function sendFetch(url, options = {}) {
  ...
  const res = await proxyExports.fetch(url, {
    ...options,
...
async function downloadTemplate(input, options = {}) {
  ...
  if (!options.offline) {
    await mkdir$1(dirname(tarPath), { recursive: true });
    const s2 = Date.now();
  ...
  await mkdir$1(extractPath, { recursive: true });
  const s = Date.now();
  const subdir = template.subdir?.replace(/^\//, "") || "";
  await tarExports.extract({
    file: tarPath,
    cwd: extractPath,
    onentry(entry) {
...
const init = defineCommand({
  ...
  async run(ctx) {
    ...
    const selectedPackageManager = packageManagerOptions.includes(
      packageManagerArg
    ) ? packageManagerArg : await logger.prompt("Which package manager would you like to use?", {
      type: "select",
    ...
    if (ctx.args.gitInit) {
      ...
      try {
        await ve("git", ["init", template.dir], {
          throwOnError: true,
          nodeOptions: {
            stdio: "inherit"
          }
...
\u2728 Nuxt project has been created with the \`${template.name}\` template. Next steps:`
    ...
    const relativeTemplateDir = relative$1(process$1.cwd(), template.dir) || ".";
...
export { requireNodeFetchNative_61758d11 as a, init$1 as i, requireNode as r };
