import 'node:fs';
import 'node:path';
import { r as requireNode, a as requireNodeFetchNative_61758d11 } from './init.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
