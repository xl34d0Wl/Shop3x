...
import { c as commonjsGlobal, g as getDefaultExportFromCjs } from '../shared/nuxi.E-ZsRS8r.mjs';
...
function execaNode(scriptPath, args, options = {}) {
	...
	const defaultExecArgv = process$2.execArgv.filter(arg => !arg.startsWith('--inspect'));
