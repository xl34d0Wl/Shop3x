...
import { j as join, a as resolve, n as normalize } from './nuxi.BZI8rqcO.mjs';
...
const importTinyexec = cached(() => import('../chunks/main.mjs').then((r) => r.x));
...
function getWorkspaceArgs(options) {
  ...
  const workspacePkg = typeof options.workspace === "string" && options.workspace !== "" ? options.workspace : undefined;
...
export { addDependency as a, detectPackageManager as d, installDependencies as i };
