...
import 'node:os';
import 'node:module';
import './nuxi.oF0sJJb9.mjs';
import fs from 'fs';
import sysPath__default from 'path';
import require$$3 from 'os';
import require$$1 from 'crypto';
import { a as getAugmentedNamespace } from './nuxi.E-ZsRS8r.mjs';
import { a as resolve } from './nuxi.BZI8rqcO.mjs';
  ...
  function interpolate2(value, parents = []) {
    ...
    return parse(
      ...
      matches.reduce((newValue, match) => {
        ...
        return value2 === undefined ? newValue : newValue.replace(replacePart, value2);
      }, value)
    );
  }
